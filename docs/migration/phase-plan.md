...
- Phase 11G.0 is the current docs-only planning step.
- No backup, restore, LAN binding, firewall work, security implementation, app containerization, or go/no-go decision is performed by 11G.0.
