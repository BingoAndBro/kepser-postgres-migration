...
- Final 11H P1 security decision.
  Phase 11H.2 note: decision framework is recorded. 11H.2a CSRF/origin protection, 11H.2b login rate-limit/brute-force protection, 11H.2c destructive admin cleanup hardening, and 11H.2d raw logical-path file-access hardening are implemented pending human retest. 11H must review 11H.2a/11H.2b/11H.2c/11H.2d retests before any final classification. 11G.6, 11H.0, 11H.1, 11H.2, 11H.2a, 11H.2b, 11H.2c, and 11H.2d documentation do not implicitly accept these risks.
