...
- **Ubah (paritas ketat, serempak)** 4 halaman detail: `pegawai/dokumen/$id/index.tsx`, `ppk/dokumen/$id/index.tsx`,
  `ppspm/dokumen/$id.tsx`, `arsiparis/dokumen/$id/index.tsx` — baris "Komponen" (Material) + sumber
...
`pegawai/dokumen/$id/index.tsx`, `ppk/dokumen/$id/index.tsx`, `ppspm/dokumen/$id.tsx`,
