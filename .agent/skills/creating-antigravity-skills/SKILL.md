...
description: Creates new Antigravity agent skills. Use when the user requests generating a new skill, managing the .agent/skills/ directory, or setting up a new skill template.
---
