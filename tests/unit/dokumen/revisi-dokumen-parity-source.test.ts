...
describe('Phase 15L.2 Revisi Dokumen parity source guard', () => {
  it('uses sectioned Revisi presentation with review and history tabs', () => {
    ...
    expect(source).toContain('rounded-b-[1.5rem] border border-t-0 border-[#F1E5DA] bg-[#FFFAF6] p-4 sm:p-5')
    ...
    expect(source).toContain("label === 'Nominal Realisasi' ? 'text-[#FF5A00]' : 'text-zinc-500'")
    expect(source).toContain("label === 'Nominal Realisasi' ? 'font-mono font-bold text-[#FF5A00]' : 'text-zinc-950'")
