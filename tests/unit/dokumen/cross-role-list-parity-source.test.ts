...
describe('Phase 15L.3A cross-role document list visual parity source guard', () => {
  it('keeps workflow list primitives aligned with the approved warm compact list pattern', () => {
    ...
    expect(workflowPrimitives).toContain('group-hover:bg-brand-surface group-hover:text-brand-solid')
  ...
  it('aligns Pegawai document/revision mobile list actions and metadata cards', () => {
    ...
    expect(pegawaiDokumen).toContain('text-zinc-950 transition-colors group-hover:text-brand-text')
    ...
    expect(pegawaiDokumen).toContain("rounded-[26px] border border-zinc-200/80 bg-bg-surface")
    expect(pegawaiDokumen).toContain("rounded-xl border border-zinc-200/80 bg-bg-surface p-2.5")
    expect(pegawaiDokumen).toContain('className="group cursor-pointer border-zinc-100 bg-bg-surface transition-colors hover:bg-brand-surface/70"')
    ...
    expect(pegawaiRevisi).toContain("rounded-xl border border-zinc-200/80 bg-bg-surface p-2.5")
    expect(pegawaiRevisi).toContain('className="group cursor-pointer border-zinc-100 bg-bg-surface transition-colors hover:bg-brand-surface/70"')
  ...
  it('keeps Pegawai Dokumen Diajukan prototype-grade refinement local and revision-safe', () => {
    ...
    expect(pegawaiDokumen).toContain("className: 'border-brand-border-strong/80 bg-brand-surface/80 text-brand-solid-active'")
  ...
  it('keeps PPSPM inbox on the shared table component instead of a local raw table', () => {
    ...
    expect(ppspmInbox).toContain('className="group cursor-pointer border-zinc-100 bg-bg-surface transition-colors hover:bg-brand-surface/70"')
  })
