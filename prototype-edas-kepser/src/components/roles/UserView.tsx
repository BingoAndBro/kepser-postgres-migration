...
export const UserView = ({ filteredDocs, selectedDoc, setSelectedDoc, role }: UserViewProps) => {
  return (
      ...
      <table className="w-full border-separate border-spacing-y-3">
        <thead>
          <tr className="text-left text-[10px] text-outline font-bold uppercase tracking-[0.1em]">
            ...
            <th className="pb-2">Current Step</th>
            <th className="pb-2 text-right pr-4">Modified</th>
          </tr>
        </thead>
        <tbody>
