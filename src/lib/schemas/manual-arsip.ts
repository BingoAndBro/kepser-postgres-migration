...
export const listManualArsipQuerySchema = z
  .object({
    fungsi_id: z.string().uuid('Fungsi tidak valid').optional(),
    kegiatan_id: z.string().uuid('Kegiatan tidak valid').optional(),
    komponen_id: z.string().uuid('Komponen tidak valid').optional(),
