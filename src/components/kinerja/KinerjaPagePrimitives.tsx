  ...
  return (
    <div
      className={cn(
        ...
        emphasis
          ? 'border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-[#FFF8F1]'
...
export function KinerjaTableShell({ children, className }: KinerjaPanelProps) {
  return (
    <div
      className={cn(
        'hidden overflow-hidden rounded-2xl border border-orange-100 bg-white shadow-sm lg:block',
        className,
      )}
    >
