...
export function ArchiveSummaryCard({
  ...
  return (
    <div
      className={cn(
        'rounded-2xl border border-orange-100 bg-white p-4 shadow-sm',
        className,
      )}
    >
...
export function ArchiveTabs<T extends string>({
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-orange-100 bg-white px-2 py-2 shadow-sm">
