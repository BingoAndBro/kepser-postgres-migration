          ...
          <aside className="min-w-0 space-y-2.5 xl:sticky xl:top-3">
            <PegawaiPanel className="border-rose-100 bg-rose-50/55 p-3 shadow-none">
              <div className="flex items-start gap-2">
                <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-bg-surface text-rose-600">
                  <AlertCircle size={13} />
                </span>
                <div className="min-w-0">
                  ...
                  <div className="mt-1.5 rounded-lg bg-bg-surface p-2">
            ...
            <PegawaiPanel className="border-brand-border-strong bg-bg-surface p-3 shadow-none">
              <div className="flex items-start gap-2">
