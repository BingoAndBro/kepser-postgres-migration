      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center gap-1.5 text-[10px] font-bold text-outline uppercase tracking-widest mb-2">
            ...
            <span className="text-primary">Dokumen Tidak Valid</span>
          </div>
          <h2 className="font-headline text-2xl font-extrabold text-on-surface">Dokumen Tidak Valid</h2>
          <p className="text-on-surface-variant text-xs mt-1">
            {items.length} dokumen ditolak dan dikembalikan ke pegawai.
          </p>
        </div>
