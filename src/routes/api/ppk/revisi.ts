...
// ---------------------------------------------------------------------------
// GET /api/ppk/revisi — list NEED_REVISION where revision_target='PPK'
// POST /api/ppk/resubmit/[id] — resubmit document to Bendahara
// ---------------------------------------------------------------------------

export const Route = createFileRoute('/api/ppk/revisi')({
  server: {
    handlers: {
