...
type PpspmSelesaiResponse = { dokumen?: Item[]; error?: string }

export const Route = createFileRoute('/ppspm/selesai')({ component: PpspmSelesaiPage })

const WORKFLOW_SEARCH_PLACEHOLDER = 'Cari judul, fungsi, atau kegiatan...'

function PpspmSelesaiPage() {
  ...
  useEffect(() => {
    apiFetch<PpspmSelesaiResponse>('/ppspm/selesai')
